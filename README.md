...
The subset version `v1.1.0` refers specifically to the extended GigaMIDI dataset, while version `v1.0.0` denotes the original GigaMIDI dataset (see [Lee et al., 2025](https://doi.org/10.5334/tismir.203)).
